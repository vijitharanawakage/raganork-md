...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'SANDESH;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "SANDESH MD",
    BOT_NAME: process.env.BOT_NAME || 'SANDESH',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '𝙼𝚁 𝚄𝙽𝙺𝙽𝙾𝚆𝙽¹¹ꫂ;Sandesh MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "94741259325",
